  ...
  return (
    <main className="min-h-screen bg-white" id="">
      ...
      <AnimatedSection delay={0}>
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <AnimatedCard delay={450} index={0}>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 xl:gap-12 justify-items-center xl:justify-items-stretch">
              ...
              <AnimatedCard delay={100} index={0}>
                <div className="w-full max-w-sm sm:max-w-md xl:max-w-none min-w-[300px] sm:min-w-[350px] xl:min-w-[420px] h-auto min-h-[280px] sm:min-h-[320px] xl:h-[350px] rounded-lg bg-[#00A2AA]/14 p-6 sm:p-8 text-left border border-gray-200 text-[#5B5858] flex flex-col justify-start shadow-lg backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:scale-105">
                  ...
                  <div className="flex-grow overflow-hidden">
                    <p className="text-sm sm:text-base font-medium text-[#716F6F] leading-relaxed">
              ...
              {/* Card 2 */}
              <AnimatedCard delay={250} index={1}>
                <div className="w-full max-w-sm sm:max-w-md xl:max-w-none min-w-[300px] sm:min-w-[350px] xl:min-w-[420px] h-auto min-h-[280px] sm:min-h-[320px] xl:h-[350px] rounded-lg bg-[#00A2AA]/14 p-6 sm:p-8 text-left border border-gray-200 text-[#5B5858] flex flex-col justify-start shadow-lg backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:scale-105">
                  <h3 className="text-xl font-bold mb-6 text-[#5B5858] overflow-hidden" style={{
                    display: '-webkit-box',
                    WebkitLineClamp: 2,
              ...
              {/* Card 3 */}
              <AnimatedCard delay={400} index={2}>
                <div className="w-full max-w-sm sm:max-w-md xl:max-w-none min-w-[300px] sm:min-w-[350px] xl:min-w-[420px] h-auto min-h-[280px] sm:min-h-[320px] xl:h-[350px] rounded-lg bg-[#00A2AA]/14 p-6 sm:p-8 text-left border border-gray-200 text-[#5B5858] flex flex-col justify-start shadow-lg backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:scale-105">
                  <h3 className="text-xl font-bold mb-6 text-[#5B5858] overflow-hidden" style={{
                    display: '-webkit-box',
                    WebkitLineClamp: 2,
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <AnimatedCard delay={50} index={0}>
                <div className="relative flex flex-col items-start text-left rounded-lg bg-white p-6 sm:p-8 shadow-md backdrop-blur-sm border border-white/20 transition-all duration-300 ease-out h-auto min-h-[280px] sm:min-h-[320px] md:h-[350px] hover:shadow-xl hover:scale-105">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className={`fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full  text-[#00A2AA] shadow-sm border-2 transition-all duration-300 ease-out bg-white hover:scale-110 hover:shadow-xl md:h-14 md:w-14 ${
